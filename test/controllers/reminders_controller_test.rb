...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { desc: @reminder.desc, end_date: @reminder.end_date, start_date: @reminder.start_date, title: @reminder.title } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { desc: @reminder.desc, end_date: @reminder.end_date, start_date: @reminder.start_date, title: @reminder.title } }
