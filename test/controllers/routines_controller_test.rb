...
class RoutinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create routine" do
    assert_difference('Routine.count') do
      post routines_url, params: { routine: { days: @routine.days, desc: @routine.desc, end_date: @routine.end_date, routine_type_id: @routine.routine_type_id, start_date: @routine.start_date, title: @routine.title } }
    end
  ...
  test "should update routine" do
    patch routine_url(@routine), params: { routine: { days: @routine.days, desc: @routine.desc, end_date: @routine.end_date, routine_type_id: @routine.routine_type_id, start_date: @routine.start_date, title: @routine.title } }
